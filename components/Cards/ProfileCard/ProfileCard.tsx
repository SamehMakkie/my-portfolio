...
const ProfileCard = () => {
  ...
  return (
    <motion.main
      ...
      className="max-w-[765px] flex flex-col gap-11 py-[80px] px-[40px] sm:p-[80px] md:p-[90px] lg:p-[100px] bg-black rounded-t-[80px] rounded-b-[50px] sm:rounded-t-[150px] sm:rounded-b-[80px]">
      <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white z-50">
        Sameh Makkie
      </h2>
      <p className="text-md md:text-lg lg:text-xl text-white leading-[30px] md:leading-[40px] lg:leading-[50px] z-50">
